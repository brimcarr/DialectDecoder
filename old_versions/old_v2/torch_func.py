...
#%% This model isn't used, ResNet18 is used instead
class CNN(nn.Module):
    def __init__(self):
        super().__init__()
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 128, (5, 5), (2, 2), (2, 2)),
            nn.BatchNorm2d(128),
            nn.ReLU(),
        ...
        self.conv = nn.Conv2d(256, 256, (3, 3), (1, 1), (1, 1))
...
def plot_loss_and_acc(train_losses, train_accs, val_losses, val_accs, model_name='', save_path=None):
...
def fully_train_model(train_dir, val_dir, num_epochs, state_dict_path):
    ...
    fig_path = current_direc + '/loss_acc_fig.png'
    plot_loss_and_acc(train_losses, train_accs, val_losses, val_accs, model_name='ResNet18', save_path=fig_path)
...
# fully_train_model(train_dir, val_dir, 25, state_dict_path)
...
# img_path = get_spec_path(test_dir, (8, 1))
