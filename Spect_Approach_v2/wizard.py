...
from torch_func import apply_cam
import torch
...
state_dict_path = current_direc + '/model_state_dict2.pth'
train_dir = current_direc + '/train_val_test/train'
val_dir = current_direc + '/train_val_test/val'
test_dir = current_direc + '/train_val_test/test'
walk_dir = current_direc + '/train_val_test/'

metadata = pd.read_csv(needed_direc + 'wizard_metadata.csv')
...
with open('current_anomalies.csv', 'w', encoding='UTF8') as f:
    writer = csv.writer(f)
### Write the header
...
pygame.display.set_caption('DialectDecoder')
...
# Classify buttons
spect_button = Button(25, 575, 150, 50, ltgrey, 'CNN Label')
loc_button = Button(225, 575, 150, 50, ltgrey, 'k-NN Label')
existing_song_button = Button(425, 575, 150, 50, ltgrey, 'Other Label')
new_song_button = Button(625, 575, 150, 50, ltgrey, 'New Label')

# Play song button
play_song_button = Button(560, 250, 200, 50, ltgrey, 'Play Song')

# Verification buttons
add_to_birds_button = Button(550, 835, 180, 50, ltgrey, 'Classify Song')
existing_confirm_button = Button(350, 835, 180, 50, ltgrey, 'Confirm Class')

# Class activation button
activation_button = Button(540, 325, 250, 50, ltgrey, 'Show Activation Map')

# Start game button
start_button = Button(300, 400, 200, 50, ltgrey, 'Start Game')
...
spect_bird_guess = (anomaly_array[0])[5]
loc_bird_guess = (anomaly_array[0])[6]

### Displays the initial guesses for the initial song
...
#%% Play song button
                    ...
                    song_time = pygame.mixer.Sound(str((anomaly_array[n])[0]) + '/' + str((anomaly_array[n])[1]))
